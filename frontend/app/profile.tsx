...
const styles = StyleSheet.create({
  ...
  customizeCard: { borderRadius: 12, padding: 16, borderWidth: 1, gap: 12 },
  customizeTitle: { fontFamily: 'PressStart2P_400Regular', fontSize: 9 },
  profileInput: { fontSize: 15, minHeight: 48, borderRadius: 10, borderWidth: 1, paddingHorizontal: 12 },
  ...
  menuSection: { gap: 10 },
  menuItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderRadius: 12, padding: 14, borderWidth: 1, minHeight: 56 },
  ...
  logoutButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderRadius: 12, padding: 16, borderWidth: 1, minHeight: 52 },
