...
const styles = StyleSheet.create({
  ...
  card: { borderWidth: 1, borderRadius: 22, padding: 24, alignItems: 'center', gap: 16 },
  title: { fontFamily: 'PressStart2P_400Regular', fontSize: 14, textAlign: 'center' },
  subtitle: { fontSize: 14, lineHeight: 20, textAlign: 'center' },
  input: { width: '100%', minHeight: 54, borderRadius: 14, borderWidth: 1, paddingHorizontal: 16, textAlign: 'center', fontSize: 18, fontWeight: '900', letterSpacing: 4 },
  ...
  secondaryButton: { width: '100%', minHeight: 48, borderRadius: 14, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
