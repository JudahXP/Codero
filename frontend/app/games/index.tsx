...
const styles = StyleSheet.create({
  ...
  langChip: { minWidth: 92, height: 42, paddingHorizontal: 12, borderRadius: 12, borderWidth: 0, justifyContent: 'center', alignItems: 'center' },
  langChipText: { fontSize: 13, fontWeight: '800', letterSpacing: 0.2 },
  scroll: { flex: 1 },
  scrollContent: { paddingHorizontal: 20, gap: 16 },
  selectedLanguageCard: { borderRadius: 14, borderWidth: 0, padding: 14, gap: 5 },
  ...
  gameCard: { flexDirection: 'row', alignItems: 'center', borderRadius: 16, padding: 16, borderWidth: 0, minHeight: 100 },
